...
//Class 3(C99) Polynomial : y = 0.04902650x6 - 2.26174643x5 + 40.84684710x4 - 370.17366979x3 + 1808.94586408x2 - 4435.86553454x + 4230.86822414 ; R² = 0.99992687
...
const curvedef curvedefs[] = {
  ...
  {3.0, 13.0, 25.0, 2500.0, 4230.86822414, -4435.86553454, 1808.94586408, -370.17366979, 40.84684710, -2.26174643, 0.04902650}, // class III - C99
};
...
{
  // windclass is the Turbine Wind Class i.e 1(I) , 2(II), 3(III)
  // v is mean wind speed (provided)
  // h1 is the elevation of the potential turbine site above sea level (m)
  ...
  h = h1 + 80 ;                     // h is the height of the turbine above sea level (m) i.e Elevation + Tower Height(80 m)
